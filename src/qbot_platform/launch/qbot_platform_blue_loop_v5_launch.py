...
def generate_launch_description():
    ...
    route_names_arg = DeclareLaunchArgument("route_names", default_value="blue,black,home")
    ...
    initial_pose_node = TimerAction(
        ...
        actions=[
            Node(
                ...
                name="publish_home_initial_pose_v5_loop",
                output="screen",
                parameters=[
                    {
    ...
    route_node = Node(
        package="qbot_platform",
        executable="route_to_targets_node.py",
        name="blue_loop_v5",
        output="screen",
        parameters=[
            {
                "targets_file": LaunchConfiguration("targets_file"),
                "route_names": LaunchConfiguration("route_names"),
                "wait_target_name": "blue",
